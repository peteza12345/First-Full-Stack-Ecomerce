...
const Canceled = () => {
  return (
    <div className='bg-slate-200 w-full max-w-md mx-auto flex justify-center items-center flex-col p-4 mt-2 rounded'>
      <img src={CANCELIMAGE} alt='cancel' width={150} height={150} />
      <p className='text-red-600 font-bold text-xl'>Payment Cancelled</p>

      <Link
        to='/cart'
        className='p-2 px-3 mt-5 border-2 border-red-600 rounded font-semibole text-red-600 hover:bg-red-600 hover:text-white'
      >
        Go To Cart
      </Link>
    </div>
